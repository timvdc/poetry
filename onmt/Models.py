...
class RNNEncoder(EncoderBase):
    ...
    def forward(self, src, lengths=None, encoder_state=None):
        ...
        #print('m', memory_bank.size())
        #print('e', type(encoder_final), len(encoder_final), encoder_final[0].size(), encoder_final[1].size())
...
class RNNDecoderBase(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        decoder_outputs = torch.stack(list(decoder_outputs))
        for k in attns:
            attns[k] = torch.stack(list(attns[k]))
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        #below for no attention, use with "-input_feed 0"
